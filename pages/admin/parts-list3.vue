      ...
      >
          <span class="flex items-center">
            <template v-if="activeVariantItem !== null">
              ...
              <span class="px-2 text-3xl text-white">
                |
              </span>
            </template>
            <p class="text-base leading-[2.5em] text-white">
        ...
        <div class="self-stretch md:w-3/4">
          <div class="flex h-full flex-col justify-between p-4">
            <div>
              ...
              <p class="mb-1">
                <span
                  class="mb-2 pt-2 pb-4 text-lg font-semibold text-white"
                >
            ...
            >
              <button
                ...
                class="
                  ...
                  items-center
                  text-white
                  hover:text-brand-slate hover:underline
              ...
              >
                <i class="ri-links-line text-white"></i>
              ...
              <button
                ...
                :class="`
                  ...
                  hover:text-brand-slate
                  hover:underline hover:decoration-brand-slate
                  ${variantCount(prod) ? 'text-brand-green' : 'text-gray-300'}
                `"
...
export default {
  ...
  data() {
    return {
      ...
      moveDialog: false,
      pageSEO: {
        title: 'Products Admin - Fighter Hive',
        description: 'Page for creating product items for Fighter Hive',
      },
  ...
  methods: {
    ...
    addFi() {
      this.showAddFightModal = true;
    },
    addVe() {
      this.showAddVenueModal = true
    },
    addFi2() {
    ...
    closeAddFightDialog() {
      this.showAddFightModal = false
    },
    closeAddPromoterDialog() {
      this.showAddPromoModal = false
    },
    closeAddFighterDialog() {
