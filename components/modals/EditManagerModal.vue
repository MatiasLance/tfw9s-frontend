...
export default {
  ...
  watch: {
    active: {
      handler(newActive) {
        if (newActive) {
          this.managerData = this.data;
          this.managerData.first = this.data.user.first_name;
          this.managerData.last = this.data.user.last_name;
          this.managerData.mobile = this.data.user.phone.replace(/[a-zA-Z]/g, '');
          this.managerData.email = this.data.user.email;
        }
      },
      immediate: true,
    },
