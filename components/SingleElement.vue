<template>
  ...
  >
    ...
    <figcaption class="text-gray-600">
      ...
      <span class="block text-xs"> {{ stock }} in stock </span>
      <div v-if="showChangesPriceStock" class="my-2 block text-xs">
        <span class="block"> New price: {{ formatCurrency(newPrice) }} </span>
    ...
    <div class="ml-11 flex flex-col items-center justify-center">
      <div class="flex items-center justify-center">
        <template v-if="photoType === 'image'">
          <div class="mx-auto my-4 flex items-end justify-end">
            <VImg
              :width="100"
              :height="100"
      ...
      >
        <VBtn class="self-end text-right text-base" @click="editElement(eid)">
